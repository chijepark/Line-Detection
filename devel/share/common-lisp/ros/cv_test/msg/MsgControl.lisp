...
(cl:defmethod cl:initialize-instance :after ((m <MsgControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_test-msg:<MsgControl> is deprecated: use cv_test-msg:MsgControl instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_test-msg:data-val is deprecated.  Use cv_test-msg:data instead.")
  (data m))
